  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#66e75] text-[16px] max-w [500px]'>Create imaginative and Visually stunning images through DALL-E AI
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          />
          <div className='relative bg-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have create the image you want,
